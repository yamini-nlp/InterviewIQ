  ...
  return (
    <div className="min-h-screen bg-night-950">
      ...
      <main className="pt-24 pb-16 px-6 max-w-5xl mx-auto">
        ...
        {!sessionId ? (
          <div className="glass rounded-2xl p-6 flex items-center gap-3 text-sm text-gray-400">
            <AlertTriangle size={16} className="text-amber-400" />
            No session selected. Choose a session from the dashboard to view its MLIM analytics.
          </div>
        ) : error ? (
          <div className="glass rounded-2xl p-6 flex items-center gap-3 text-sm text-red-400">
